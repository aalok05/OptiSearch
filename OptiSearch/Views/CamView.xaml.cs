...
namespace OptiSearch.Views
{
    ...
    public sealed partial class CamView : Page
    {
        ...
        protected override async void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            if (!OcrEngine.IsLanguageSupported(ocrLanguage))
            {
                ...
                dialog.PrimaryButtonClick += delegate { Frame.Navigate(typeof(StartPage)); };
            ...
            else
            {
                ...
                catch(Exception exp)
                {
                    ...
                    var dialog = NotifyService.NotifyUser("Something went wrong.", exp.Message);
                    dialog.MaxWidth = this.ActualWidth;
                    dialog.PrimaryButtonClick += delegate {Frame.Navigate(typeof(StartPage)); };
        ...
        private async void Application_Suspending(object sender, SuspendingEventArgs e)
        {
            ...
            if (Frame.CurrentSourcePageType == typeof(StartPage))
            {
        ...
        private async void ExtractButton_Tapped(object sender, Windows.UI.Xaml.Input.TappedRoutedEventArgs e)
        {
            ...
            currentFrame = await GetVideoFrame();
        ...
        private async Task InitializeCameraAsync()
        {
            ...
            if (mediaCapture == null)
            {
                ...
                { 
                    var dialog = NotifyService.NotifyUser("No camera device found.", "");
                    dialog.MaxWidth = this.ActualWidth;
                    dialog.PrimaryButtonClick += delegate { Frame.Navigate(typeof(StartPage)); };
                ...
                catch (UnauthorizedAccessException)
                {
                    ...
                    var dialog = NotifyService.NotifyUser("Denied access to the camera.", "");
                    dialog.MaxWidth = this.ActualWidth;
                    dialog.PrimaryButtonClick += delegate { Frame.Navigate(typeof(StartPage)); };
                    await dialog.ShowAsync();
        ...
        private async Task StartPreviewAsync()
        {
            ...
            catch (Exception ex)
            {
                ...
                var dialog = NotifyService.NotifyUser("Exception starting preview.", "Exception : " + ex.Message);
                dialog.MaxWidth = this.ActualWidth;
                dialog.PrimaryButtonClick += delegate { Frame.Navigate(typeof(StartPage)); };
                var result = await dialog.ShowAsync();
            }
        ...
        private async Task SetPreviewRotationAsync()
        {
            ...
            // Set preview rotation in the previw source.
        ...
        private async Task<VideoFrame> GetVideoFrame()
        {
            ...
            // Create the video frame to request a SoftwareBitmap preview frame.
            var videoFrame = new VideoFrame(BitmapPixelFormat.Bgra8, videoFrameWidth, videoFrameHeight);
            return await mediaCapture.GetPreviewFrameAsync(videoFrame);
        }
